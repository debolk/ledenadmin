...
(function() {
  ...
  Bolk.BlipRequest = (function(_super) {
    ...
    BlipRequest.photo_src = function(uid, width, height) {
      ...
      return "" + Bolk.BlipRequest.EndPoint + (BlipRequest.photo_api(uid, width, height)) + "?access_token=" + ((_ref = document.router) != null ? (_ref1 = _ref.session) != null ? _ref1.token : void 0 : void 0);
    };
